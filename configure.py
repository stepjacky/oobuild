...
parser.add_option("--module", action="store", type="string", dest="module", default="server", help="defines what modules to build. You can specify several of them, e.g. --module 'core desktop builder server mobile'")
...
parser.add_option("--qt-dir", action="store", type="string", dest="qt-dir", default="C:/Qt/6.2.4", help="defines qmake directory path. qmake can be found in qt-dir/compiler/bin directory")
